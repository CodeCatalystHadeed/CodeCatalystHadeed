...
<!-- TYPING SVG -->
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=20&pause=1000&color=4F46E5&center=true&vCenter=true&width=600&lines=Python+%7C+FastAPI+%7C+LLMs+%7C+RAG;Building+AI-powered+backend+systems;Open+to+Junior+Backend+%2F+AI+roles" />
</p>

## 🤖 About me

Backend and AI developer focused on building production-ready APIs and
LLM-powered systems with Python and FastAPI. Currently seeking junior
backend or AI engineer roles.

- 🔭 Working on: RAG pipelines and FastAPI microservices
- 🌱 Studying: LangChain, vector databases, LLM fine-tuning  
- 📫 Reach me: [LinkedIn](your-link) · [Email](mailto:you@email.com)
